...
public class Withdraw {
    ...
    private static double readWithdrawAmount() {
        double amount = 0.0;
    ...
    private static boolean updateAccountBalance(String accountNumber, double amount) {
        try {
            File file = new File(FILE_PATH);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (details.length >= 12 && details[0].equals(accountNumber)) {
                    ...
                    details[11] = Double.toString(balance);
                }
